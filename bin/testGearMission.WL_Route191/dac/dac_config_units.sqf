...
// RHS Russian MSV (EMR Summer Camo)
  case 8:
  {
    ...
    _Unit_Pool_V = ["CUP_O_GAZ_Vodnik_PK_RU","RHS_Ural_Open_msv_01"];
    _Unit_Pool_T = ["rhs_btr80_msv"];
...
// WWII Soviets (Summer)
  case 16:
  {
    _Unit_Pool_S = ["LIB_SOV_tank_crew","LIB_SOV_pilot","LIB_SOV_lieutenant","LIB_SOV_mgunner","LIB_SOV_medic","LIB_SOV_smgunner","LIB_SOV_LC_rifleman","LIB_SOV_sapper","LIB_SOV_p_officer","LIB_SOV_smgunner_summer","LIB_SOV_LC_rifleman_summer","LIB_SOV_Operator","LIB_SOV_captain_summer"];
...
// Arma 1 SLA (CUP)
  case 22:
  {
    _Unit_Pool_S = ["CUP_O_sla_Crew","CUP_O_sla_Pilot","CUP_O_sla_Soldier_SL","CUP_O_sla_Soldier_MG","CUP_O_sla_Medic","CUP_O_sla_Soldier_GL","CUP_O_sla_Soldier","CUP_O_sla_Soldier_Backpack","CUP_O_sla_Soldier_AMG","CUP_O_sla_Soldier","CUP_O_sla_Soldier_LAT","CUP_O_sla_Soldier_AR","CUP_O_sla_Soldier_Backpack"];
    _Unit_Pool_V = ["CUP_O_UAZ_MG_SLA","CUP_O_Ural_SLA"];
    _Unit_Pool_T = ["CUP_O_BTR60_SLA","CUP_O_BRDM2_SLA"];
    _Unit_Pool_A = ["LOP_UA_Mi8MT_Cargo","LOP_UA_Mi8MT_Cargo","LOP_UA_Mi8MTV3_FAB"];
  }; 
//-------------------------------------------------------------------------------------------------
// RHS Nationalist Militia
  case 23:
  {
    _Unit_Pool_S = ["rhfgref_nat_crew","rhfgref_nat_crew","rhsgref_nat_commander","rhfgref_nat_machinegunner","rhfgref_nat_medic","rhfgref_nat_grenadier","rhfgref_nat_rifleman","rhfgref_nat_rifleman_m92","rhfgref_nat_militiaman_kar98k","rhfgref_nat_grenadier_rpg","rhfgref_nat_rifleman_aks74","rhfgref_nat_rifleman_akms"];
    _Unit_Pool_V = ["CUP_I_Datsun_PK"];
    _Unit_Pool_T = [];
    _Unit_Pool_A = [];
  }; 
//-------------------------------------------------------------------------------------------------
...
// Arma 2 Chernarussian Defence Force
  case 25:
  {
    _Unit_Pool_S = ["rhsgref_cdf_ngd_crew","rhsgref_cdf_ngd_crew","rhsgref_cdf_ngd_squadleader","rhsgref_cdf_ngd_machinegunner","rhsgref_cdf_ngd_medic","rhsgref_cdf_ngd_grenadier","rhsgref_cdf_ngd_rifleman","rhsgref_cdf_ngd_m92","rhsgref_cdf_ngd_rifleman","rhsgref_cdf_ngd_rifleman","rhsgref_cdf_ngd_grenadier_rpg"];
    _Unit_Pool_V = ["LOP_CDF_UAZ","LOP_CDF_Ural_open","LOP_CDF_Ural"];
    _Unit_Pool_T = ["LOP_CDF_BMP2","LOP_CDF_BTR60","LOP_CDF_BTR60"];
