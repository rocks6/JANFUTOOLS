//This module allows people who join in progress to teleport to their squad leader.
// Set FW_JIPTYPE as "Teleport" to enable JIP tele, set as "TRANSPORT" to only request transport, set as "DENY" to disable all options.
